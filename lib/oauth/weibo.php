...
class SaeTOAuthV2 {
	 ...
	 */
	function __construct($client_id, $client_secret, $callback_url, $access_token = NULL, $refresh_token = NULL) {
	...
	public static function build_http_query_multi($params) {
        ...
        function login()
        {
            ...
            $code_url = $this->getAuthorizeURL($this->callback_url, 'code', $state);
            header("Location:$code_url");
        }
        
        /*
         * Callback: added by ccheng
         */
        function callback()
        {
